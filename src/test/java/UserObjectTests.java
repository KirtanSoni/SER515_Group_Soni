...
import src.main.java.org.classes.Users;
import src.main.java.org.classes.UserAuthentication;
import src.main.java.org.classes.UserManagement;

public class UserObjectTests implements ITest {
    public UserObjectTests() {
        test();
        System.out.println("All UserObjects Test are passed");
    }
    @Override
    public void test() {
