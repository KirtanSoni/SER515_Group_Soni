...
public class ViewSprintBacklog extends javax.swing.JFrame {
    ...
    public ViewSprintBacklog() {
        ...
        backlogTable.getColumnModel().getColumn(4).setCellRenderer(new TableActionCellRenderDelete());
        backlogTable.getColumnModel().getColumn(4).setCellEditor(new TableActionCellEditorDelete());
...
//        UIManager.put("progress.selectionForeground",Color.WHITE);
    ...
    private void initComponents() {
        ...
        backlogTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
                ...
                mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(mainPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(mainPanelLayout.createSequentialGroup()
                                                .addComponent(sprintBacklogLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
                                                .addGap(12, 12, 12)
